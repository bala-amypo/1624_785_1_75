...
public class ScoreAuditLogController {
    ...
    public ResponseEntity<String> createAuditLog(@PathVariable Long visitorId,@PathVariable Long ruleId) {
         return ResponseEntity.ok("Audit log created for visitor " + visitorId + " and rule " + ruleId);
    }
